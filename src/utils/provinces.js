export const provinces = [
    ...
    { code: "073", name: "Ibiza y Formentera" },
    { code: "351", name: "Lanzarote" },
    { code: "352", name: "Fuerteventura" },
    { code: "353", name: "Gran Canaria" },
    { code: "381", name: "Tenerife" },
    { code: "382", name: "La Gomera" },
    { code: "383", name: "La Palma" },
    { code: "384", name: "El Hierro" },
];
